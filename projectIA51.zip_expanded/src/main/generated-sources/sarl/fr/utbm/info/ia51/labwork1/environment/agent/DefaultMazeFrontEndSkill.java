...
public class DefaultMazeFrontEndSkill extends Skill implements MazeFrontEnd {
  private Address defaultAddressInMazeSpace;
  ...
  public void install() {
    ...
    this.mazeSpace = _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1.getDefaultContext().<MazeSpace>getOrCreateSpaceWithSpec(MazeSpaceSpecification.class, spaceId, _$CAPACITY_USE$IO_SARL_CORE_BEHAVIORS$CALLER.asEventListener());
    if (((this.mazeSpace.getCreatorID() != null) && (!Objects.equal(this.mazeSpace.getCreatorID(), this.getOwner().getID())))) {
