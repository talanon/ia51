...
public class DriverBody extends AgentBody {
  public DriverBody(final int x, final int y, final City city, final UUID agentId, final int perceptionDistance) {
    super(x, y, city, agentId, perceptionDistance);
  }
  
  public DriverBody(final Point2i position, final City city, final UUID agentId, final int perceptionDistance) {
